...
var MenuComponent = /** @class */ (function () {
    ...
    MenuComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.obersableQuantité.subscribe(function (q) {
            _this.quantite += q;
        });
    };
...
var PanierComponent = /** @class */ (function () {
    ...
    PanierComponent.prototype.ngOnInit = function () {
        ...
        this.calculTotal();
        this.data.observableCalculTotal.subscribe(function (e) {
            if (e) {
                _this.calculTotal();
            }
        });
        this.data.observableDelete.subscribe(function (produit) {
            var product = _this.data.fruitPaniers.find(function (x) { return x.id == produit.id; });
            if (product) {
                _this.data.fruitPaniers.splice(_this.data.fruitPaniers.indexOf(product), 1);
            }
        });
    };
    PanierComponent.prototype.calculTotal = function () {
        var _this = this;
        this.total = 0;
        this.data.fruitPaniers.forEach(function (p) {
            _this.total += _this.data.fruits.find(function (f) { return f.id == p.id; }).prix * p.quantite;
        });
    };
    PanierComponent.ctorParameters = function () { return [
        { type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
    ]; };
...
var ProduitCatalogComponent = /** @class */ (function () {
    function ProduitCatalogComponent(data) {
        var _this = this;
        this.data = data;
        this.ajouter = function () {
            //this.data.fruitPaniers.push(this.produit);
            var p = _this.data.fruitPaniers.find(function (x) { return x.id == _this.produit.id; });
            if (p) {
                p.quantite++;
            }
            else {
                _this.data.fruitPaniers.push({ id: _this.produit.id, quantite: 1 });
            }
            _this.data.obersableQuantité.next(1);
        };
    }
    ProduitCatalogComponent.ctorParameters = function () { return [
        { type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
    ]; };
    ...
    return ProduitCatalogComponent;
}());
...
var ProduitPanierComponent = /** @class */ (function () {
    function ProduitPanierComponent(data) {
        var _this = this;
        this.data = data;
        this.update = function (q) {
            _this.fruitPanier.quantite += q;
            _this.data.obersableQuantité.next(q);
            if (_this.fruitPanier.quantite == 0) {
                _this.data.observableDelete.next(_this.fruitPanier);
            }
            _this.data.observableCalculTotal.next(true);
        };
    }
    ProduitPanierComponent.prototype.delete = function () {
    ...
    ProduitPanierComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.fruitPanier.produit = this.data.fruits.find(function (x) { return x.id == _this.fruitPanier.id; });
    };
    ProduitPanierComponent.ctorParameters = function () { return [
        { type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
